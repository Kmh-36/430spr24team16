...
import './AddOSProject.css';

function AddOSProject({ userToken }) {
  ...
  const handleAddProject = async (event) => {
    ...
    try {
      const response = await axios.post(`${SERVER_URL}/Add_OS_Project`, projectData, {
        headers: {
  ...
  return (
    <div className="add-os-project-container">
      <h2>Add OS Project</h2>
